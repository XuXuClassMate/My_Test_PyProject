...
class Manual_add(BasePage):
    def add_name(self, add_name):
        ...
        name = self.find(MobileBy.XPATH, '//*[contains(@text,"姓名")]/../android.widget.EditText')
    ...
    def add_num(self, add_num):
        ...
        num = self.find(MobileBy.XPATH, '//*[contains(@text,"帐号")]/../android.widget.EditText')
        num.send_keys(add_num)
        return self

    def add_another_name(self, add_another_name):
        # another_name = self.driver.find_element(MobileBy.XPATH, '//*[contains(@text,
        # "别名")]/../android.widget.EditText')
        another_name = self.find(MobileBy.XPATH, '//*[contains(@text,"别名")]/../android.widget.EditText')
    ...
    def add_iphone_num(self, add_iphone_num):
        ...
        iphone_num = self.find(MobileBy.XPATH, '//*[contains(@text,"手机号")]')
