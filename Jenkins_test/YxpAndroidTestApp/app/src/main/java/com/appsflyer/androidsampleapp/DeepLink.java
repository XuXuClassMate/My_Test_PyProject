...
import java.util.Map;
  ...
  /** Test this deep link with the link : https://yxpandroidtestapp.onelink.me/Pvqj */
  /** run: $ adb shell am start -a android.intent.action.VIEW -d https://yxpandroidtestapp.onelink.me/Pvqj */
